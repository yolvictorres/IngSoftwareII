        ...
        <div class="col-md-3">
            <div class="panel panel-default ">
                <ul class="nav nav-pills nav-stacked">
                    <li ><a href="postulados.jsp">Postulados</a></li>
                    <li ><a href="preseleccionados.jsp">Pre-seleccionados</a></li>
                    <li class="active"><a href="rechazados.jsp">Rechazados</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-7">
            <div class="panel panel-heading"> <center><h1>Rechazados</h1></center></div><br>
            <div class="panel panel-default">
                <table id="table12" class="table table-striped table-hover" >
                    ...
                    <tbody>
                        <%
                            ...
                            int idEmpres = (Integer.parseInt(idEmpresa));
                            List<Postulados> p = daoem.mostrarNuevosPostulados(2, idEmpres);
                        ...
                        <tr>
                            ...
                            %>
                            <td class="col-md-7">Se rechazo la solicitud de <b><%=person.getNombresPersona()%> <%=person.getApellidosPersona()%></b> para el empleo <b><%=empleo.getDetalles()%></b></td>
                            <td class="col-md-1"><input type="button" name="" value="Perfil" class="btn btn-default " id="button" onclick="location.href = 'verPersona.jsp?id=' + (<%=person.getIdPersona()%>);"></td>
                            <td class="col-md-1"><input type="button" name="" value="Hoja de vida" class="btn btn-default " id="button" onclick="javascipt:window.open('<%=person.getRutaHojadevida()%>');"></td>
                                <%
                                    }
                                %>
                ...
                <div class="alert alert-warning">
                    <p>No se ha <strong>rechazado</strong> personal.</p>            
                </div>            
                <% }%>
            </div>
        </div>
